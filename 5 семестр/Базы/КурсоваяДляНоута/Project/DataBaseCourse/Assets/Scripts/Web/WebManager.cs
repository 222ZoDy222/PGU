...
public class WebManager : MonoBehaviour
{
    ...
    private const string REGISTRATION_URL = "http://localhost/pgu/Registration/Registration.php";
    ...
    private const string AUTHENTICATION_URL = "http://localhost/pgu/Registration/Registration.php";
    ...
    private const string SUBJECTS_URL = "http://localhost/pgu/Labs/Subjects.php";
    ...
    private const string TASK_URL = "http://localhost/pgu/Labs/Tasks.php";
    ...
    private const string QUESTIONS_URL = "http://localhost/pgu/Labs/Questions.php";
